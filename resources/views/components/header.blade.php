      ...
      <div class="container-fluid"><img class="logo" src="/assets/images/logo.png" alt="">
          ...
          <div id="navbarSupportedContent" class="collapse navbar-collapse">
              <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold">Accedi</a></li>
                  <li class="nav-item"><a href="#" class="nav-link text-uppercase font-weight-bold">Registrati</a></li>
              </ul>
          </div>
      </div>
  </nav>
