...
$factory->define(Apartment::class, function (Faker $faker) {
    return [
      'title' => $faker -> randomElement($array = array ("TRASTEVERE APARTMENT","Il Cavallino","Santa Marta","Marconi Apartment 1","Flower House","New City Center Duomo","Appartamento Sole","Crêuza da me","Nennolina","A casa di nonna Elena","La casetta di MIRO")),
